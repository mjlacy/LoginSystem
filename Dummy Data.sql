INSERT INTO `loginsystem`.`users` (`id`, `first`, `last`, `uid`, `pwd`, `email`, `type`) VALUES ('1', 'Michael', 'Lacy', 'admin', '1234', 'mjlacy.dude@gmail.com', 'Admin');

INSERT INTO `loginsystem`.`users` (`id`, `first`, `last`, `uid`, `pwd`, `email`, `type`) VALUES ('2', 'Craig', 'Johnson', 'Craig', '1234', '2dude10@gmail.com', 'Standard User');
